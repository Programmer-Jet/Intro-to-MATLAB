...
%of deposits given a set of monthly gain rates (interest rates). Rates can
...
function [accounts, totalGained, totalMoney] = jet157Recitation7Problem4(accounts,deposits,...
    accountRates)

[time, numAccounts] = size(accountRates);
[time2, numDeposits] = size(deposits);

%This is an example of you can create your own errors. We need all of
...
if ~(numAccounts == length(accounts) && numAccounts == numDeposits &&...
        time == time2)
